...
[![LeetCode](https://img.shields.io/badge/View%20on-LeetCode-ffa116?style=flat-square&logo=leetcode&logoColor=ffa116)](https://leetcode.com/problems/linked-list-cycle/)
...
|--------|:-----------:|:------------:|
| ⚡ Runtime | 11 ms (Beats 43%) | **11 ms (Beats 43%)** 🆕 |
| 💾 Memory  | 14.3 MB (Beats 11%) | **14.3 MB (Beats 11%)** |
...
| # | File | Language | Date |
|:-:|------|:--------:|:----:|
| 1 | [sol1.cpp](./sol1.cpp) | `C++` | 2026-08-18 |
| 2 | [sol2.cpp](./sol2.cpp) | `C++` | 2026-08-18 ← **latest** |
